...
const char * const BITCOIN_CONF_FILENAME = "jermabux.conf";
const char * const BITCOIN_PID_FILENAME = "jermabux.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Jermabux";
#else
    // Unix
