...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jermabux-project/jermabux>";
    const std::string URL_WEBSITE = "<https://jermabux.org>";
