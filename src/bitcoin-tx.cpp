...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jermabux-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jermabux-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jermabux transaction") + "\n" +
              "  jermabux-tx [options] -create [commands]   " + _("Create hex-encoded jermabux transaction") + "\n" +
              "\n";
